...
const githubLoginLink = withQuery('/api/login', { connection_id: 'conn_018f08807674382a5fc7726a468fdaf1' })
const emailLoginLink = computed(() => withQuery('/api/login', { connection_id: 'conn_018f08807674e7c18a2daf6d90bd3e84', login_hint: email.value }))
</script>
